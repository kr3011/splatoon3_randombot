 ...
 */
async function fetchFourRandomWeapons() {
 ...
 */
async function getDoubleFourMatchWeapons() {
  // 💡 각각 독립된 랜덤 뽑기를 실행하여 완벽히 격리된 팀 생성
  const alphaTeam = await fetchFourRandomWeapons();
  const bravoTeam = await fetchFourRandomWeapons();
